...
export class AsignaturasDetailComponent implements OnInit {
  ...
  addComent(comentario: string){
    if(this.asignatura.comentarios[0] == comentario){
      this.asignatura.comentarios[0] = comentario;
    }else{
      //this.asignatura.comentarios.push(comentario);
    }
  }
